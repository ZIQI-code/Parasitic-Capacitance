...
for i = 1:600
    C_R_N16_44(i) = (C_R_N16_44_00(i)+C_R_N16_44_01(i)+C_R_N16_44_02(i))/3;
    C_I_N16_44(i) = (C_I_N16_44_00(i)+C_I_N16_44_01(i)+C_I_N16_44_02(i))/3;
end
figure(3)
...
%analze resonant frequency
syms k b
[k,b] = solve(4.47139==k*54549200+b, -2072.67==k*54714500+b,k,b);
...
for i = 1:600
    K_R_N16_43(i) = (K_R_N16_43_00(i)+K_R_N16_43_01(i)+K_R_N16_43_02(i))/3;
    K_I_N16_43(i) = (K_I_N16_43_00(i)+K_I_N16_43_01(i)+K_I_N16_43_02(i))/3;
end
figure(19)
