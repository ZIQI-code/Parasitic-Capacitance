...
L_K_T_0 = flip([K_I_N20_T_00(2),K_I_N18_T_00(2),K_I_N16_T_00(2),K_I_N14_T_00(2),K_I_N12_T_00(2),K_I_N10_T_00(2),K_I_N8_T_00(2)]./(1e5*(2*pi)));
L_K_T_1 = flip([K_I_N20_T_01(2),K_I_N18_T_01(2),K_I_N16_T_01(2),K_I_N14_T_01(2),K_I_N12_T_01(2),K_I_N10_T_01(2),K_I_N8_T_01(2)]./(1e5*(2*pi)));
L_K_T_2 = flip([K_I_N20_T_02(2),K_I_N18_T_02(2),K_I_N16_T_02(2),K_I_N14_T_02(2),K_I_N12_T_02(2),K_I_N10_T_02(2),K_I_N8_T_02(2)]./(1e5*(2*pi)));
...
F_K_T = [7.5369     6.5116    5.7864    5.2238    4.6112    4.2236    3.8485].*1.0e+07;
...
figure(99)
plot(x2,F_C_32,x2,F_K_31_A,x2,F_K_48,x2,F_C_50,x2,F_K_27,x2,F_K_T,x2,F_K_25)
legend('C-32','K-31','K-48','C-50','K-27','K-T','K-25')
...
figure(96)
% plot(x2,C_32_CT,x2,K_31_CT,x2,C_50_CT,x2,K_48_CT,x4,simuC,x2,K_25_CT,x2,K_T_CT)
plot(x2,C_32_CT,x2,K_31_CT,x2,C_50_CT,x2,K_48_CT,x2,K_25_CT,x2,K_T_CT)
% plot(x2,C_50_CT,x2,K_48_CT,x2,K_27_CT,x4,simuC)
title('Total Capacitance at Resonant Frequency')
legend('C-32','K-31','C-50','K-48','K-25','K-T')
grid on
%%
figure(95)
plot(x2,L_C_32_A,x2,L_C_50_A,x2,L_K_31_new_A,x2,L_K_48_A,x2,L_K_80_A,x2,L_K_27_A,x2,L_K_25,x4,simuL)
% plot(x2,L_C_50_A,x2,L_K_48_A,x2,L_K_27_A)
title('Inductance at 100kHz')
legend('C-32','C-50','K-31','K-48','K-80','K-27','K-25','simu')
grid on
%%
figure(94)
