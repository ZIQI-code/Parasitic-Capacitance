...
% K_25_CT = [2.3542, 2.5728, 2.6650, 2.8867, 3.0101, 3.1170, 3.3334].*1E-12;
K_25_CT = [2.3542, 2.5728, 2.6650, 2.8867, 3.1050, 3.2784, 3.4700].*1E-12;
...
Rlist = [15,14,13,9.95,9.9,9.85,9.8];
for i = 1:7
    open(model(i))
    sdo.setValueInModel(model(i), 'Cc', 3.36e-13);
    sdo.setValueInModel(model(i), 'Cp', 3.45e-14);
